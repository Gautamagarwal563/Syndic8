...
const agents = [
  ...
  },
  {
    ...
    description: "Name + context in. A ready-to-send, hyper-personalized cold email out — with subject line, body, and PS. Not a template. An actual email.",
    tags: ["Sales"],
    price: "$1.00", priceUnit: "per email", icon: "✉️", speed: "~10s",
    examples: ["Sam Altman, OpenAI — pitching AI infra", "Garry Tan, YC — applying for W26", "Jensen Huang, NVIDIA — partnership"],
    badge: "New",
  },
  {
    id: "hn-pulse",
    name: "HackerNews Pulse",
    description: "Topic or company in. Real-time HN sentiment out — what the technical community actually thinks, the top threads, and whether the discourse is growing or dying.",
    tags: ["Research"],
    price: "$0.75", priceUnit: "per pulse", icon: "🔶", speed: "~8s",
  ...
  },
  {
    ...
    description: "GitHub URL in. Full repo analysis out — health, momentum, bus factor, what the commits reveal about priorities, and a straight verdict on project trajectory.",
    tags: ["Research", "Strategy"],
    price: "$2.00", priceUnit: "per repo", icon: "🐙", speed: "~12s",
    examples: ["github.com/vercel/next.js", "github.com/anthropics/anthropic-sdk-python", "facebook/react"],
    badge: "New",
  },
  {
    id: "tos-analyzer",
    name: "TOS Analyzer",
    description: "Any URL in. Plain English breakdown of what you actually agreed to — data collection, red flags, arbitration clauses, and an overall verdict.",
    tags: ["Research"],
    price: "$1.00", priceUnit: "per analysis", icon: "📋", speed: "~12s",
  ...
  },
  {
    ...
    description: "Company name in. Read their job listings like a strategy consultant — what they're building, where they're hurting, and where they're headed in 12 months.",
    tags: ["Research", "Strategy"],
    price: "$0.75", priceUnit: "per company", icon: "📌", speed: "~10s",
